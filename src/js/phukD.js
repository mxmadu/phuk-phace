...
let model;
gltfLoader.load('https://mxmadu.github.io/phuk-phace/models/compressed_D.glb', function(gltf) {
  model = gltf.scene;
  ...
  scene.add(model);
    ...
    },
    {
      ...
      images: [
          { src: 'https://mxmadu.github.io/phuk-phace/img/drow.jpeg', alt: 'Drow from Dungeons and Dragons. They have charcoal-black skin and white hair, pointy ears, long faces and noses. This one is pictured in a long, geometrically-shaped dress and holding a whip of snakes in its left hand', caption: '&lt;Drow*_in_dungeons_and_dragons&gt;' },
          { src: 'https://mxmadu.github.io/phuk-phace/img/scar.jpg', alt: 'Scar from the Lion King, he has a long angular face, green eyes, a purple scar down his left eye and a wicked grin', caption: '&lt;Scar_in_the_lion_king&gt;' }
      ],
